...
import com.company.logicstic.notification.event.TenantNotificationListener;
...
class NotificationProducerTest {
  ...
  void persistsTenantEventAsUnreadNotification() {
    ...
    NotificationService service =
        new NotificationServiceImpl(repository, Mappers.getMapper(NotificationMapper.class));
