...
import com.company.logicstic.shared.common.PaginationValidator;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;

/**
 * Tests for {@link PaginationValidator} to ensure page/pageSize bounds are enforced correctly for
 * all edge cases.
 */
...
class PaginationValidatorTest {
  ...
  void validatePageSize_atMax() {
    assertEquals(
        Constants.MAX_PAGE_SIZE, PaginationValidator.validatePageSize(Constants.MAX_PAGE_SIZE));
  }
  ...
  void validatePageSize_exceedsMax() {
    assertEquals(
        Constants.MAX_PAGE_SIZE, PaginationValidator.validatePageSize(Constants.MAX_PAGE_SIZE + 1));
  }
