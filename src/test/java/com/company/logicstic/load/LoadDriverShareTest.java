 ...
 * <p>
 * Business spec: {@code DriverShare = DeliveryCost × GetDriversShareRatio()}
 * where ratio = sum of salaryAmount of main/secondary drivers with SalaryType = "ShareOfGross"
 * and must be 0 ≤ ratio ≤ 1.
 */
