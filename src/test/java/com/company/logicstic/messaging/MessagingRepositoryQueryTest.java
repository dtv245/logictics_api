package com.company.logicstic.messaging;
...
import com.company.logicstic.messaging.message.Message;
import com.company.logicstic.messaging.message.MessageRepository;
...
class MessagingRepositoryQueryTest {
  ...
  private Set<Class<?>> scanModuleEntities() {
    ...
    return scanner.findCandidateComponents("com.company.logicstic").stream()
