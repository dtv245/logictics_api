...
/**
 * Pure unit tests for {@link EmployeeMapper} using Mappers.getMapper().
 * No Spring context required — avoids DB dependency in test suite.
 * Verifies parity with the old {@code EmployeeView.from()} logic.
 */
class EmployeeMapperTest {
    ...
    void toEntity_mapsScalarFieldsCorrectly_andIgnoresFk() {
        CreateEmployeeRequest req = new CreateEmployeeRequest(
                "emp@example.com", "Alice", "Walker",
                "+555", "MONTHLY", "ACTIVE",
                OffsetDateTime.now(), UUID.randomUUID(),
                BigDecimal.valueOf(5000), "EUR",
                "123 Main St", null, "Berlin", "BE", "10115", "DE"
        );
    ...
    void toView_matchesOldFromMethodOutput() {
        ...
        EmployeeView expected = new EmployeeView(
                empId, "test@co.com", "Test", "User", "000",
                "FIXED", "INACTIVE", OffsetDateTime.parse("2023-01-01T00:00:00Z"),
                roleId, "ADMIN", BigDecimal.valueOf(3000), "USD",
                "Addr1", "Addr2", "City", "ST", "12345", "US"
        );
