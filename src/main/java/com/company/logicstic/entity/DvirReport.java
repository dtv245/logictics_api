...
@Table(
    ...
    schema = "public",
    indexes = {
        @Index(name = "ix_dvir_reports_driver_id_inspection_date", columnList = "driver_id,inspection_date"),
        ...
        @Index(name = "ix_dvir_reports_truck_id_inspection_date", columnList = "truck_id,inspection_date")
    }
)
@Getter
@Setter
