...
@Table(
    ...
    schema = "public",
    indexes = {
        @Index(name = "ix_hos_violations_employee_id_violation_date", columnList = "employee_id,violation_date"),
...
public class HosViolation {
    ...
    @Column(name = "rule_set_code", nullable = false, length = 32, columnDefinition = "varchar(32) DEFAULT 'FMCSA'")
