...
public class TenantRegistryService {
  ...
  private static final RowMapper<TenantRegistryRecord> TENANT_ROW_MAPPER =
      (rs, rowNum) ->
          new TenantRegistryRecord(
  ...
  public Optional<TenantRegistryRecord> findActiveTenant(String tenantId) {
    List<TenantRegistryRecord> tenants =
        tenantRegistryJdbcTemplate.query(
            """
  ...
  public void registerActiveTenant(
      String tenantId, String dbUrl, String dbUsername, String plaintextDbPassword) {
    tenantRegistryJdbcTemplate.update(
        ...
        dbUrl,
        dbUsername,
        credentialCipher.encrypt(plaintextDbPassword));
  }
}
