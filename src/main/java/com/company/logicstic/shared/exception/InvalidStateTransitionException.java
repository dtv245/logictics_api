...
/**
 * Thrown when an invalid state transition is attempted (e.g. trying to dispatch an already-delivered load).
 */
public class InvalidStateTransitionException extends ApiException {
    ...
    public InvalidStateTransitionException(String entityName, String currentState, String targetState) {
        super(
                ...
                String.format("Cannot transition %s from '%s' to '%s'", entityName, currentState, targetState)
        );
