 ...
 * <p>
 * Provides static helper methods to build {@code WHERE} clauses with optional,
 * null-safe predicates — reducing repetitive {@code @Query} definitions in
 * repositories and keeping filters consistent across the application.
 */
public final class BaseSearchSpecification {
     ...
     */
    @SafeVarargs
    public static <T> Specification<T> searchIn(String search, java.util.function.Function<Root<T>, String>... fields) {
