...
/**
 * Class cấu hình Swagger/OpenAPI. @Configuration: - Đánh dấu đây là một class cấu hình của Spring.
...
public class OpenApiConfig {
  ...
  /**
   * @Bean: - Tạo một đối tượng OpenAPI và đưa vào Spring IoC Container. - Spring chỉ tạo 1 instance
   * duy nhất và sử dụng lại trong toàn bộ ứng dụng.
   */
  @Bean
