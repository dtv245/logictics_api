 ...
 * <p>
 * The {@code load} and {@code inspectedBy} FK relations are ignored during entity mapping
...
public interface InspectionMapper {
    ...
    @Mapping(target = "loadId", expression = "java(report.getLoad() != null ? report.getLoad().getId() : null)")
    @Mapping(target = "inspectedById", expression = "java(report.getInspectedBy() != null ? report.getInspectedBy().getId() : null)")
    @Mapping(target = "inspectedByName", expression = "java(report.getInspectedBy() != null ? report.getInspectedBy().getFirstName() + \" \" + report.getInspectedBy().getLastName() : null)")
