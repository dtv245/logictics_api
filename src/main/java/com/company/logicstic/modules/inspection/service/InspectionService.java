...
import com.company.logicstic.modules.inspection.dto.DefectRequest;
...
public class InspectionService
    extends AbstractBaseService<LoadConditionReport, InspectionView, CreateInspectionRequest> {
  ...
  public PagedResponse<InspectionView> search(
  ...
  private void resolveRelations(LoadConditionReport report, CreateInspectionRequest req) {
    ...
    report.setInspectedBy(
        employeeRepository
            .findById(req.inspectedById())
            .orElseThrow(
                () -> new ResourceNotFoundException("Employee not found: " + req.inspectedById())));
  }
