 ...
 * <p>
 * The {@code role} FK relation is intentionally ignored during entity mapping
 * — the service resolves it via {@link com.company.logicstic.repository.TenantRoleRepository}
 * and sets it on the entity before saving.
 */
...
public interface EmployeeMapper {
     ...
     */
    @Mapping(target = "roleId", expression = "java(employee.getRole() != null ? employee.getRole().getId() : null)")
    @Mapping(target = "roleName", expression = "java(employee.getRole() != null ? employee.getRole().getName() : null)")
