...
public class EmployeeService extends AbstractBaseService<Employee, EmployeeView, CreateEmployeeRequest> {
    ...
    public EmployeeService(EmployeeRepository employeeRepository, TenantRoleRepository roleRepository,
        ...
        super(employeeRepository, employeeMapper::toView, employeeMapper::toEntity, employeeMapper::updateEntity);
    ...
    public PagedResponse<EmployeeView> searchDrivers(String search, String status,
                                                      int page, int pageSize, String orderBy, boolean descending) {
        var pageable = pageRequest(page, pageSize, orderBy, descending);
        return toPagedResponse(employeeRepository.search(search, status, null, pageable));
    }
