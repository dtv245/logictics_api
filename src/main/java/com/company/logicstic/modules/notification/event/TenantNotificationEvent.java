 ...
 *
 * <p>The notification schema has no recipient column. The tenant boundary is therefore the
 * database selected for the current request, rather than an individual employee.
 */
