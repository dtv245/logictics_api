...
@Profile("!nodb")
@Service
public class CustomerService extends AbstractBaseService<Customer, CustomerView, CreateCustomerRequest> {

    private final CustomerRepository customerRepository;
    private final CustomerMapper customerMapper;

    public CustomerService(CustomerRepository customerRepository, CustomerMapper customerMapper) {
        super(customerRepository, customerMapper::toView, customerMapper::toEntity, customerMapper::updateEntity);
