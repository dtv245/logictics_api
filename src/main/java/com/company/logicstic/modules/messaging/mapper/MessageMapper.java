 ...
 *
 * <p>The {@code conversation} and {@code sender} FK relations are ignored during entity mapping —
...
public interface MessageMapper {
  ...
  @Mapping(
      ...
      expression =
          "java(message.getConversation() != null ? message.getConversation().getId() : null)")
  @Mapping(
      target = "senderId",
      expression = "java(message.getSender() != null ? message.getSender().getId() : null)")
  @Mapping(
      target = "senderName",
      expression =
