 ...
 * <p>
 * The {@code load} FK is ignored during entity mapping — the service resolves it.
 * The {@code participants} and {@code messages} collections are managed separately.
 */
...
public interface ConversationMapper {
    ...
    @Mapping(target = "loadId", expression = "java(conversation.getLoad() != null ? conversation.getLoad().getId() : null)")
