...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PagedResponse<PaymentView>>> search(
        ...
        PagedResponse<PaymentView> data = paymentService.search(status, invoiceId, page, pageSize, orderBy, descending);
        return ResponseEntity.ok(ApiResponse.success(data, request));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PaymentView>> getById(@PathVariable UUID id, HttpServletRequest request) {
