...
public class InvoiceService
    extends AbstractBaseService<Invoice, InvoiceView, CreateInvoiceRequest> {
  ...
  public PagedResponse<InvoiceView> search(
      String status,
      String type,
      UUID customerId,
      UUID employeeId,
    ...
    if (req.employeeId() != null) {
      invoice.setEmployee(
          employeeRepository
              ...
              .orElseThrow(
                  () -> new ResourceNotFoundException("Employee not found: " + req.employeeId())));
    } else {
