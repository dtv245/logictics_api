...
public interface RoleMapper {
  ...
  @Mapping(
      target = "claims",
      expression =
          "java(role.getClaims() == null ? java.util.List.of() : role.getClaims().stream().map(c -> new com.company.logicstic.role.RoleResponse.ClaimView(c.getId(), c.getClaimType(), c.getClaimValue())).toList())")
